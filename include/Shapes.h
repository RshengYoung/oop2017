...
class Rectangle : public Shape
{
  ...
  public:
    Rectangle(double ulcx, double ulcy, double length, double width, std::string name = "r") : Shape(name), x(ulcx), y(ulcy), l(length), w(width) {}
...
class Circle : public Shape
{
  ...
  public:
    Circle(double centerX, double centerY, double radius, std::string name = "c") : Shape(name), cx(centerX), cy(centerY), r(radius) {}
...
class Triangle : public Shape
{
  ...
  public:
    Triangle(vertex vertex_A, vertex vertex_B, vertex vertex_C, std::string name = "t") : Shape(name), v1(vertex_A), v2(vertex_B), v3(vertex_C)
    {
